...
<!-- <div class="equation" align="center" data-raw-text="\sigma = \sqrt{\frac{1}{N} \sum_{i=0}^{N-1} (x_i - \mu)^2}" data-equation="eq:population_standard_deviation">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@e0727de08be6b07ec832c0537cdd4e43356b3577/lib/node_modules/@stdlib/stats/base/dnanstdevpn/docs/img/equation_population_standard_deviation.svg" alt="Equation for the population standard deviation.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="\mu = \frac{1}{N} \sum_{i=0}^{N-1} x_i" data-equation="eq:population_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@e0727de08be6b07ec832c0537cdd4e43356b3577/lib/node_modules/@stdlib/stats/base/dnanstdevpn/docs/img/equation_population_mean.svg" alt="Equation for the population mean.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="s = \sqrt{\frac{1}{n-1} \sum_{i=0}^{n-1} (x_i - \bar{x})^2}" data-equation="eq:corrected_sample_standard_deviation">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@e0727de08be6b07ec832c0537cdd4e43356b3577/lib/node_modules/@stdlib/stats/base/dnanstdevpn/docs/img/equation_corrected_sample_standard_deviation.svg" alt="Equation for computing a corrected sample standard deviation.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="\bar{x} = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:sample_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@e0727de08be6b07ec832c0537cdd4e43356b3577/lib/node_modules/@stdlib/stats/base/dnanstdevpn/docs/img/equation_sample_mean.svg" alt="Equation for the sample mean.">
    <br>
</div> -->
...
```javascript
dnanstdevpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dnanstdevpn@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-dnanstdevpn/tags). For example,

```javascript
dnanstdevpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dnanstdevpn@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dnanstdevpn = require( 'path/to/vendor/umd/stats-base-dnanstdevpn/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dnanstdevpn@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-dnanstdevpn.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-dnanstdevpn

[test-image]: https://github.com/stdlib-js/stats-base-dnanstdevpn/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/stats-base-dnanstdevpn/actions/workflows/test.yml?query=branch:v0.2.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-dnanstdevpn/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-dnanstdevpn?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-dnanstdevpn.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-dnanstdevpn/main
...
[deno-readme]: https://github.com/stdlib-js/stats-base-dnanstdevpn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-dnanstdevpn/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-dnanstdevpn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-dnanstdevpn/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-dnanstdevpn/blob/esm/README.md
